...
export interface ACSLiveShareHostOptions {
     ...
     */
    communicationTokenProvider: () => Promise<string>;
}
...
export class ACSLiveShareHost implements ILiveShareHost {
    ...
    /**
     * Static constructor for `ACSLiveShareHost`.
     * @param options props needed to join/configure a Live Share session
     * @returns an `ILiveShareHost` implementation for ACS
     */
    ...
    private get localClientInfo(): IClientInfo {
        return {
            userId: this.options.communicationUserId,
    ...
    public async getFluidTenantInfo(): Promise<IFluidTenantInfo> {
        ...
        const token = await this.options.communicationTokenProvider();
    ...
    private constructBaseRequest(): ILiveShareRequestBase {
        ...
        return {
            ...
            teamsContext: {
                meetingJoinUrl: this.options.meetingLink,
            },
        };
    }
