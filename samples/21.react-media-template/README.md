...
1. Open `.\manifest\manifest.json` and update values in it, including your [Application ID](https://learn.microsoft.com/previous-versions/windows/desktop/msipcthin2/application-id).
