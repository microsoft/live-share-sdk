...
export const FlexRow = forwardRef<HTMLDivElement, IFlexRowOptions>(
    (props, ref) => {
        ...
        const mergedClasses = mergeClasses(
            ...
            gap === "smaller" && wrap && flexRowStyles.gapSmallerWrap,
            gap === "small" && flexRowStyles.gapSmall,
            gap === "small" && wrap && flexRowStyles.gapSmallWrap,
            gap === "medium" && flexRowStyles.gapMedium,
            gap === "medium" && wrap && flexRowStyles.gapMediumWrap,
            gap === "large" && flexRowStyles.gapLarge,
            gap === "large" && wrap && flexRowStyles.gapLargeWrap,
