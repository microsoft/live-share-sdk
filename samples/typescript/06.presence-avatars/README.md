# Presence Avatars sample

![GIF showing the sample functionality](./assets/06-readme-preview-image.gif)

This sample shows how to use [Live Share React](../../../packages/live-share-react) and Fluent UI to create presence avatars for users in the Live Share session. It also shows how to set custom metadata for each user and display it on the hover state of the avatars.
